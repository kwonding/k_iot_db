...
value (127, 32767, 2000000000, 9000000000000);

-- insert into `integer` 
-- value (128, 32767, 2000000000, 9000000000000);
# Error Code: Out of range value for column t_col at row 1
...
values ('Laptop Samsung Book 3 Pro', '전자제품', '삼성 갤럭시 북 3 노트북 프로입니다. 아주 좋아요', 'example');
...
insert into product
values (12345.67, 123456.7890, 999999999.99);
