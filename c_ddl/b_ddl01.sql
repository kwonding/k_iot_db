...
DROP DATABASE IF EXISTS database_name; # 존재 할 때 > 삭제

# 2. 데이터베이스 선택(USE)
# : DB 선택 시 이후 모든 SQL 명령어가 선택된 DB내에서 실행
...
describe student;
desc student; # cf) descending(desc) 내림차순 // 테이블명앞에 쓰이면 describe
