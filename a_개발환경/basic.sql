...
# === 5. 다크 모드 설정 (선택) ===
# : Edit > Preferences > Fonts & Colors > Color Schemas (Window 8 선택)
# https://github.com/mleandrojr/mysql-workbench-dark-theme/blob/master/code_editor.xml 다운로드
# 파일 탐색기 > C드라이브 > Program Files > MySQL > My SQL Workbench8.0 > data > code Editor.xml 바꾸기
